...
<html>
	<head>
        ...
        <meta name="title" content="UPDATE PW"/>
		...
		<title>UPDATE PW｜TYPESERVICE</title>
		<style type="text/css">
		...
		<div class="container content" style="margin-top:5%">
			<div class="login-member">
				...
				<form action="${pageContext.request.contextPath}/member/modifypw" method="post" id="modifyPwForm" class="login-form">
					...
					<div class="login-member__form">
						<div class="mt-4">
							<button type="button" id="submitBtn" class="login-button__item login-button__item--black">비밀번호 수정</button>
						</div>
					</div>
				</form>
			</div>
