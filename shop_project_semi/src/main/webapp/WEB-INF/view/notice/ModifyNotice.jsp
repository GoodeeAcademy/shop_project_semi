			...
			<form method="post" action="${pageContext.request.contextPath}/ModifyNoticeController">
				...
				<div class="row p-b-25">
					<div class="col-sm-6 p-b-5">
						...
						<input type="text" name="noticeTitle" value="${notice.noticeTitle}" class="size-111 bor8 stext-102 cl2 p-lr-20">
					</div>
					<div class="col-sm-6 p-b-5">
					...
					<div class="col-12 p-b-5">
						...
						<textarea rows="10" cols="10" name="noticeContent" class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10">${notice.noticeContent}</textarea>
					</div>
				</div>
				<button type="submit" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">수정</button>
			</form>
		</div>
	</div>
