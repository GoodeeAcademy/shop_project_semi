...
<body>
	...
	<div>
		<c:if test="${currentPage > 10}">
			<a href="${pageContext.request.contextPath}/QuestionListForEmpController?currentPage=${currentPage-10}">이전</a>
		</c:if>
		...
		<c:if test="${currentPage+10 < lastPage}">
			<a href="${pageContext.request.contextPath}/QuestionListForEmpController?currentPage=${currentPage+10}">다음</a>
		</c:if>
	</div>
</body>
</html>