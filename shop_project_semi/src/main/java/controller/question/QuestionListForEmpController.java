...
public class QuestionListForEmpController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int lastPage = (int)Math.ceil(questionService.getCountQuestionListForEmp()/(double)rowPerPage);
		...
		// view
		request.getRequestDispatcher("/WEB-INF/view/question/questionListForEmp.jsp").forward(request, response);
	}
